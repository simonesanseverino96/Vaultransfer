...
// Upload: max 30 upload ogni 10 minuti per IP
...
// Download: max 30 tentativi ogni minuto per IP (anti brute-force)
...
// Checkout / sensitive actions: max 20 per 10 minutes per IP
